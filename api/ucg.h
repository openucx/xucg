...
enum ucg_params_field {
    ...
    UCG_PARAM_FIELD_REDUCE_CB    = UCS_BIT(2), /**< Callback for reduce ops */
    UCG_PARAM_FIELD_TYPE_INFO_CB = UCS_BIT(3), /**< Operation/datatype info */
    UCG_PARAM_FIELD_MPI_IN_PLACE = UCS_BIT(4), /**< MPI_IN_PLACE value */
    UCG_PARAM_FIELD_HANDLE_FAULT = UCS_BIT(5)  /**< Fault-tolerance support */
};
 ...
 * initialization by @ref ucg_init_version or @ref ucg_init .
 */
...
enum ucg_collective_modifiers {
    ...
    UCG_GROUP_COLLECTIVE_MODIFIER_VARIABLE_LENGTH    = UCS_BIT( 5), /* otherwise fixed length */
    UCG_GROUP_COLLECTIVE_MODIFIER_AGGREGATE_PARTIAL  = UCS_BIT( 6), /* MPI_Scan */
    ...
    UCG_GROUP_COLLECTIVE_MODIFIER_AGGREGATE_EXCLUDE  = UCS_BIT( 9), /* MPI_Exscan */
    UCG_GROUP_COLLECTIVE_MODIFIER_IN_PLACE           = UCS_BIT(10), /* otherwise two buffers */
    UCG_GROUP_COLLECTIVE_MODIFIER_VARIABLE_DATATYPE  = UCS_BIT(11), /* otherwise fixed data-type */
    UCG_GROUP_COLLECTIVE_MODIFIER_PERSISTENT         = UCS_BIT(12), /* otherwise destroy coll_h */
    UCG_GROUP_COLLECTIVE_MODIFIER_BARRIER            = UCS_BIT(13), /* prevent others from starting */
